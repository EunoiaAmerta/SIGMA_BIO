...
export function RankCard({
  ...
  return (
    <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-primary/10 via-background to-accent/5">
      {/* Background accent */}
      <div className="absolute top-0 right-0 w-20 h-20 sm:w-24 md:w-32 bg-primary/5 rounded-full -mr-10 sm:-mr-16 -mt-10 sm:-mt-16" />
      ...
      <div className="relative p-4 sm:p-6 space-y-3 sm:space-y-4">
        ...
        <div className="flex items-start justify-between">
          ...
          {isTop10 && (
            <Badge className="bg-orange-500/20 text-orange-700 dark:text-orange-300 border-0 gap-1 text-xs sm:text-sm py-0.5 sm:py-1">
        ...
        {/* Medal Display */}
        {getMedalEmoji() && (
          <div className="text-4xl sm:text-5xl text-center py-1 sm:py-2">
            {getMedalEmoji()}
          </div>
        )}
